...
public class RegisterPage extends JFrame {
    ...
    private static final Color PRIMARY_COLOR = new Color(40, 167, 69); // Green for register
    private static final Color PRIMARY_HOVER_COLOR = new Color(30, 145, 55); // Darker green
    ...
    public RegisterPage() {
        ...
        JButton goLoginBtn = new JButton("Back to Login");
        styleSecondaryButton(goLoginBtn);
    ...
    private void doRegister() {
        ...
        String checkSql = "SELECT 1 FROM login WHERE username = ?";
        ...
        String insertSql = "INSERT INTO login (username, password, usertype, isActive) VALUES (?, ?, ?, ?)";
        int rowsAffected = 0;
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            e.printStackTrace();
            errorMsg.setText("Registration failed due to database error.");
            return;
        }
